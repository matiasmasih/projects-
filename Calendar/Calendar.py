...
TODAY_COLOR = 'cyan'
DEFAULT_COLOR = 'pink'
MAIN_BG_COLOR = 'lightblue'  # Set the desired background color here
...
class CalendarApp(tk.Tk):
    ...
    def create_month_view(self, frame, year, month):
        ...
        ttk.Label(header_frame, text=calendar.month_name[month], font=("Helvetica", 14, "bold"), background=MAIN_BG_COLOR).pack()
        ...
        for day_name in day_names:
            tk.Label(days_frame, text=day_name, font=("Courier New", 12, "bold"), bg="lightgreen", width=2, height=1, relief="solid").grid(row=0, column=day_names.index(day_name), padx=1, pady=1)
